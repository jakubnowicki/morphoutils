...
#'
#' Combine multi-dimensional arrays. This is a generalization of cbind and rbind. Takes a sequence of vectors, matrices, 
#' 
#' @param ... a
#' @param along a
#' @param rev.along a
...
#' @param force.array a
#' @param make.names a
#' @param use.anon.names a
#' @param use.first.dimnames a
#' @param hier.names a
#' @param use.dnns a
#' @export
...
abind.2 <- function (..., along = N, rev.along = NULL, new.names = NULL, 
